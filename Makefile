...
mac:
	clang --std=c99 *.c -L lib/mac-osx -framework CoreVideo -framework IOKit -framework Cocoa -framework GLUT -framework OpenGL lib/mac-osx -o $(BUILD_DIR)pong-c-macosx
